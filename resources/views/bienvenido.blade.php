...
<div class="be-content  contenido proveedor" style="height: 100vh;">
    ...
    @if(Session::has('listanegra'))
        <div class="modal fade" id="modalListaNegra" tabindex="-1" role="dialog" aria-labelledby="modalListaNegraLabel"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-danger" role="alert">
                            <strong>Atención:</strong> Los siguientes proveedores tienen problemas para descargar sus
                            comprobantes desde SUNAT.
                        ...
                        <div class="form-group mb-3">
                            ...
                            <small class="form-text text-muted">
                                Total de proveedores: <span
                                    id="totalProveedores">{{ count(Session::get('listanegra')) }}</span>
                            </small>
                        </div>
