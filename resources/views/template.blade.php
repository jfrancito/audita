...
<head>
  ...
  <title>UGEL CHICLAYO - {{$titulo}}</title>


  <link rel="stylesheet" type="text/css"
    href="{{ asset('public/lib/perfect-scrollbar/css/perfect-scrollbar.min.css') }}" />
  <link rel="stylesheet" type="text/css"
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('public/css/casagoza.css?v=' . $version) }} " />
  <link rel="stylesheet" type="text/css" href="{{ asset('public/css/nav-premium.css?v=' . $version) }} " />
</head>
...
<body>
  ...
  <script src="{{ asset('public/lib/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js') }}"
