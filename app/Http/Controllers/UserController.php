...
class UserController extends Controller
{
	...
	public function actionAjaxModalConfiguracionCuentaBancariaContrato(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mdatoscuentabancariacontrato',
			[
				'usuario' => $usuario,
				'idoc' => $idoc,
	...
	public function actionAjaxModalConfiguracionCuentaBancariaPG(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mdatoscuentabancariapg',
			[
				'usuario' => $usuario,
				'idoc' => $idoc,
				'prefijo_id' => $prefijo_id,
	...
	public function actionAjaxModalConfiguracionCuentaBancariaEstiba(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mdatoscuentabancariaestiba',
			[
				'usuario' => $usuario,
				'idoc' => $idoc,
	...
	public function actionAjaxModalConfiguracionCuentaBancariaLiqComAn(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mdatoscuentabancarialiqcoman',
			[
				'usuario' => $usuario,
				'idoc' => $idoc,
				'empresa_id' => $empresa_id,
	...
	public function actionAjaxModalConfiguracionCuentaBancariaOC(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mdatoscuentabancariaoc',
			[
				'usuario' => $usuario,
				'idoc' => $idoc,
				'prefijo_id' => $prefijo_id,
	...
	public function actionAjaxModalConfiguracionCuentaBancariaLQ(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mdatoscuentabancarialg',
			[
				'usuario' => $usuario,
				'idoc' => $idoc,
				'idopcion' => $idopcion,
	...
	public function actionAjaxModalVerCuentaBancariaLQ(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mvercuentabancaria',
			[
	...
	public function actionAjaxModalVerCuentaBancariaOCIndividual(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mvercuentabancariaindividual',
			[
	...
	public function actionAjaxModalCambiarReparable(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mcambiarreparable',
			[
	...
	public function actionAjaxModalConfiguracionDatosProveedor(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mdatospersonales',
			[
				'usuario' => $usuario,
				'ajax' => true,
			]
	...
	public function actionAjaxModalConfiguracionDatosContacto(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mdatoscontacto',
			[
				'usuario' => $usuario,
				'ajax' => true,
			]
	...
	public function actionAjaxModalConfiguracionCuentaBancaria(Request $request)
	{
		...
		return View::make(
			'usuario/modal/ajax/mdatoscuentabancaria',
			[
				'usuario' => $usuario,
				'combo_banco' => $combo_banco,
				'defecto_banco' => $defecto_banco,
			...
			if (count($tusuario) > 0) {
				...
				if ($clavedesifrada == $clave) {
					...
					$listamenu = WEBGrupoopcion::join('web.opciones', 'web.opciones.grupoopcion_id', '=', 'web.grupoopciones.id')
						...
						->where('web.opciones.ind_audita', '=', 1)
	...
	public function actionListarUsuarios($idopcion)
	{
		...
		/******************************************************/
		$array_rols = WEBRol::where('ind_audita', '=', 1)
			->pluck('id')
			->toArray();
	...
	public function actionAgregarUsuario($idopcion, Request $request)
	{
		...
		if ($_POST) {
			...
			$rol = DB::table('WEB.Rols')->where('ind_audita', '=', 1)->where('id', '<>', $this->prefijomaestro . '00000001')->pluck('nombre', 'id')->toArray();
	...
	public function actionAgregarTercero($idopcion, Request $request)
	{
		...
		if ($_POST) {
			...
			$rol = DB::table('WEB.Rols')->where('ind_audita', '=', 1)->where('id', '=', '1CIX00000048')->pluck('nombre', 'id')->toArray();
	...
	public function actionListarRoles($idopcion)
	{
		...
		$listaroles = WEBRol::where('id', '<>', $this->prefijomaestro . '00000001')->where('ind_audita', '=', 1)->orderBy('id', 'asc')->get();
